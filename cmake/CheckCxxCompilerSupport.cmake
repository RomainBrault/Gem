...
if (${CMAKE_CXX_COMPILER_ID} STREQUAL "Clang")
    ...
    ### which is known to be unable to compile Gem. Consider switching to
...
elseif (${CMAKE_CXX_COMPILER_ID} STREQUAL "AppleClang")
    ...
    ### which is shipped with Xcode < 6.3. Unfortunately, only Apple's Clang
    ### >= 6.1.0 (shipped with Xcode >= 6.3) is supported by Gem.
...
elseif (MSVC)
    ...
    ###
    ### More information about how to set up Gem with Clang for Windows is
    ### available on Gem's wiki at http://git.io/vBYIp.
    ")
else()
    message(WARNING "
    ### You appear to be using a compiler that is not yet tested with Gem.
    ### Please tell us whether it successfully compiles or if and how it
    ### fails by opening an issue at https://github.com/boostorg/Gem/issues.
    ### Thanks!
    ")
endif()
